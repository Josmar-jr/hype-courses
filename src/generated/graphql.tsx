...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, slug?: string | null, title: string, lessonType: LessonType, availableAt?: any | null }> };
...
export function useGetLessonBySlugQuery(options?: Omit<Urql.UseQueryArgs<GetLessonBySlugQueryVariables>, 'query'>) {
  return Urql.useQuery<GetLessonBySlugQuery, GetLessonBySlugQueryVariables>({ query: GetLessonBySlugDocument, ...options });
};
...
export function useGetLessonsQuery(options?: Omit<Urql.UseQueryArgs<GetLessonsQueryVariables>, 'query'>) {
  return Urql.useQuery<GetLessonsQuery, GetLessonsQueryVariables>({ query: GetLessonsDocument, ...options });
};